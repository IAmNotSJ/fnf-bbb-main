...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Warning Sign Summon', "Values don't mean anything, used for Battery's shock mechanic"],
		['Warning Sign Beat', "Values don't mean anything, used for Battery's shock mechanic"],
